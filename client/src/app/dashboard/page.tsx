            ...
            <Tabs defaultValue="overview" className="space-y-4">
              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="grid gap-4 m-auto md:grid-cols-2">
                  ...
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                      <CardTitle className="text-sm font-medium">Ingevuld</CardTitle>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="none"
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{countTypes(students)}</div>
                      <p className="text-xs text-muted-foreground">
                        {Math.round((countTypes(students) / students.length) * 100)}% van het totaal
                      </p>
                    </CardContent>
                  </Card>
                </div>
